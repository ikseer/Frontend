...
export default function GuestNavBar() {
  ...
  return (
    <>
      <div className="min-h-[70px] md:h-[70px] "></div>
      <header className="fixed top-0 min-h-[70px] md:h-[70px] bg-white  flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full text-sm">
        <nav
