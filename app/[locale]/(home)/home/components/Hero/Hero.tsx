  ...
  return (
    ...
    >
      <div className="w-full pl-10 md:w-9/12 lg:w-6/12">
        <h1
          className="text-2xl  font-bold text-white 
                dark:text-zinc-900 text-center md:text-start"
        >
          Smart pharmacy{' '}
        </h1>
        <p className="text-slate-200 mt-5 mb-8 dark:text-zinc-800 text-lg font-light dark:font-medium text-center md:text-start">
      ...
      <img
        src={hero.src}
        alt="hero-section"
        className="h-full md:w-4/12 md:mr-50 lg:right-0 lg:w-5/12 hidden md:block absolute right-0 "
      />
    </div>
  );
}
